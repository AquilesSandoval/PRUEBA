...
// Initialize zone values for all sports and types
["Time", "Distancia"].forEach(function(type) {
    ["Ciclismo", "Natacion"].forEach(function(sport) {
        updateZoneValues(type, sport, 10, 0);
    });
    updateZoneValues(type, "Carrera", 10, type === "Time" ? 30 : 0);
});
